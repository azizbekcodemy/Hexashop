...
import car1 from "../pages/images/kid-01.jpg"
import car2 from "../pages/images/kid-02.jpg"
import car3 from "../pages/images/kid-03.jpg"
...
function Kids() {
    return (
        <>
            <Typography id="kidis" sx={{ borderBottom: "3px dotted #eee", marginTop: "90px", paddingBottom: "90px", marginBottom: "70px" }}>
                <Grid container justifyContent="center" spacing={0}>
                    <Grid item xs={12} sm={12} md={12} lg={10.6} xl={11.2}  >
                        <Typography >
                            <Grid container justifyContent="center" spacing={0}>
                                <Grid item xs={10.3} sm={9.6} md={10.3} lg={10.5} xl={9.3}  >
                                    <Box>
                                        ...
                                        <Carousel  className="lorem" pagination={false} breakPoints={breakPoints} >
                                            ...
                                            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={{marginTop:"20%"}}>
                                                <Box className="container">
                                                    <img src={car1} alt="Avatar" className="image" />
